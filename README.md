...
[test-image]: https://github.com/stdlib-js/types/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/types/actions/workflows/test.yml?query=branch:v0.2.0
